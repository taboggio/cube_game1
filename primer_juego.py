...
#enemy
enemigo_size = 50
enemigo_pos =[random.randint (0,ANCHO- enemigo_size),0] #se le resta el size para que no salga en el borde
...
#dibujo enemigo_pos
    ...
    #Dibujar jugador                        #EjeX           #EjeY
    pygame.draw.rect(ventana, color_pers, (jugador_pos[0],jugador_pos[1], jugador_size,jugador_size))
